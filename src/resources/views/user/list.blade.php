    ...
    <main class="attendance-main">
        ...
        <div class="attendance-controls-box">
            <div class="attendance-controls">
                <a href="{{ route('attendance.list', ['year' => \Carbon\Carbon::create($year, $month, 1)->subMonth()->year, 'month' => \Carbon\Carbon::create($year, $month, 1)->subMonth()->month]) }}"
                ...
                <a href="{{ route('attendance.list', ['year' => \Carbon\Carbon::create($year, $month, 1)->addMonth()->year, 'month' => \Carbon\Carbon::create($year, $month, 1)->addMonth()->month]) }}"
        ...
        <table class="attendance-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('attendance.detail', ['id' => $attendance->id]) }}" class="detail-link">詳細</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
